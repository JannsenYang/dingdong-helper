...
# 更新! 2022.4.23 抓包参数接口变更 当前小程序版本：2.85.1

新版本更新后，原本的接口maicai.api.ddxq.mobi/cart 发现已经消失了 可更换接口解决, 获取方式不变, 参考 image/headers.jpeg 和 body.jpeg
![api](image/new-api-2.85.1.png)
